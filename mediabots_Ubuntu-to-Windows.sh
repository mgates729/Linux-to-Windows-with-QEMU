...
if [ $link1_status = "200" ] ; then 
	sudo wget -O /mediabots/WS2012R2.ISO https://software-download.microsoft.com/db/Win10_20H2_v2_English_x64.iso?t=57c4b1eb-4f19-49db-bf99-607bd63df9af&e=1621368872&h=c78cd6fc21b9959cf96fdb45c0bb6e8e 
elif [ $link2_status = "200" -o $link2_status = "301" -o $link2_status = "302" ] ; then 
	sudo wget -P /mediabots https://software-download.microsoft.com/db/Win10_20H2_v2_English_x64.iso?t=57c4b1eb-4f19-49db-bf99-607bd63df9af&e=1621368872&h=c78cd6fc21b9959cf96fdb45c0bb6e8e
else
